...
class HolyBulb extends StatefulWidget {
  @override
  _HolyBulbState createState() => _HolyBulbState();
}

class _HolyBulbState extends State<HolyBulb> {
              ...
              builder: (context, apertRampActive) => Row(
                children: [
                  svgIcon(
                      ...
                      activeIcon: "assets/icons/Button_ApertureRamp_Enable.svg",
                      inactiveIcon:
              ...
              children: [
                Row(
                  children: [
                    svgIcon(
                        active: bulbRamp,
                        activeIcon: "assets/icons/Button_BulbRamp_Enable.svg",
                        inactiveIcon:
                            "assets/icons/Button_BulbRamp_Disable.svg"),
                    SizedBox(
                      width: 12.sp,
                    ),
                    Column(
                ...
                Row(
                  children: [
                    svgIcon(
                        active: deflicker,
                        activeIcon: "assets/icons/Button_Deflicker_Enable.svg",
                        inactiveIcon:
                            "assets/icons/Button_Deflicker_Disable.svg"),
                    SizedBox(
                      width: 12.sp,
                    ),
                    Column(
