...
class FstopKeyFrameDurationTab extends StatefulWidget {
  final String url;

  const FstopKeyFrameDurationTab({Key key, @required this.url})
      : super(key: key);
  @override
  _FstopKeyFrameDurationTabState createState() =>
      _FstopKeyFrameDurationTabState();
}

class _FstopKeyFrameDurationTabState extends State<FstopKeyFrameDurationTab> {
                  ...
                  if (json["RSP"]["CONTROL_FSTOP"] != null) {
                    if (json["RSP"]["CONTROL_FSTOP"] == "OK") {
                      ...
                      if (json["RSP"]["CONTROL_FSTOP"]["CHOICE"] != null) {
                        fstop =
                            FSTOPRESPONSE.fromJson(jsonDecode(snapshot.data));
