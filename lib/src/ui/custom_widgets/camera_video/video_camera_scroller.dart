...
class VideoCameraScroller extends StatefulWidget {
  @override
  _VideoCameraScrollerState createState() => _VideoCameraScrollerState();
}

class _VideoCameraScrollerState extends State<VideoCameraScroller> {
  ...
  final List<String> list = ["PHOTO", "VIDEO"];
