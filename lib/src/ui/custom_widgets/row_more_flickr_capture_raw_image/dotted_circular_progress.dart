...
import 'dotted_circle/neo_circular_countdown.dart';
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<SecondsRecieverBloc, int>(
      builder: (context, seconds) {
        return Center(
          child: NeoCircularCountdown(
              strokeWidth: 2,
              countdownCurrentColor: HexColor.neoBlue(),
              countdownTotalColor: HexColor.dedGray(),
              gapFactor: 2,
