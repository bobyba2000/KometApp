...
class MinuteVerticalScroller extends StatefulWidget {
  final Function(int min) selectedMin;

  const MinuteVerticalScroller({Key key, this.selectedMin}) : super(key: key);

  @override
  _MinuteVerticalScrollerState createState() => _MinuteVerticalScrollerState();
}

class _MinuteVerticalScrollerState extends State<MinuteVerticalScroller> {
          ...
          child: NotificationListener(
            onNotification: (notification) {
              if (notification is ScrollEndNotification) {
                widget.selectedMin(seconds[curIndex]);
              }
              return true;
            },
