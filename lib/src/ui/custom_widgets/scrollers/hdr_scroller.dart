...
import 'package:neo/src/ui/custom_widgets/hdr/expanded_items/horizontal_picker.dart';
...
class HDRscroller extends StatefulWidget {
  final String url;
  ...
  const HDRscroller(
      ...
      : super(key: key);
  @override
  _HDRscrollerState createState() => _HDRscrollerState();
}

class _HDRscrollerState extends State<HDRscroller>
