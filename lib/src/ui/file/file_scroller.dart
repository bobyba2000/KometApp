...
class FileScroller extends StatefulWidget {
  @override
  _FileScrollerState createState() => _FileScrollerState();
}

class _FileScrollerState extends State<FileScroller> {
  ...
  final List<String> list = ["SD-MMC", "USB-HDD"];
