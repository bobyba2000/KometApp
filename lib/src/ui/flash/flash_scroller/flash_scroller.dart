...
class FlashScroller extends StatefulWidget {
  @override
  _FlashScrollerState createState() => _FlashScrollerState();
}

class _FlashScrollerState extends State<FlashScroller> {
  ...
  final List<String> list = ["CHANNEL", "GROUP"];
